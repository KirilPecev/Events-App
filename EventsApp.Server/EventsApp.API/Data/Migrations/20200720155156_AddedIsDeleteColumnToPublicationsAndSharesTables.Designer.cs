...
namespace EventsApp.API.Data.Migrations
{
    ...
    [Migration("20200720155156_AddedIsDeleteColumnToPublicationsAndSharesTables")]
    partial class AddedIsDeleteColumnToPublicationsAndSharesTables
    {
            ...
            modelBuilder.Entity("EventsApp.API.Data.Models.Friend", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Friends_Status_Enum_Constraint", "[Status] IN(1, 2)");
                });
            ...
            modelBuilder.Entity("EventsApp.API.Data.Models.Publication", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Publications_Type_Enum_Constraint", "[Type] IN(0, 1)");
                });
            ...
            modelBuilder.Entity("EventsApp.API.Data.Models.User", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_AspNetUsers_Gender_Enum_Constraint", "[Gender] IN(1, 2)");
                });
